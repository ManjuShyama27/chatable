...
class ChatableScreen extends StatefulWidget {
  @override
  _ChatableScreenState createState() => _ChatableScreenState();
}

class _ChatableScreenState extends State<ChatableScreen> {
        ...
        child: ListView(
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              accountName: Text(username, style: TextStyle(fontSize: 16)),
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return Center(
            child: CircularProgressIndicator(backgroundColor: Colors.pink[200]),
          );
        }
      },
    );
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Material(
            ...
            color: user ? Colors.pink[200] : Colors.white,
            elevation: 5,
            child: Padding(
